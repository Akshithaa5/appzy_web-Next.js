    ...
    <section className="hero bg-cream-500 py-24" id="Hero">
      <div className="container mx-auto flex flex-col md:flex-row items-center">
        <div className="hero-text md:w-1/2 text-center md:text-left mb-10 md:mb-0">
          ...
          <div className="flex justify-center md:justify-start">
            ...
            <button
              ...
              className="bg-blue-800 text-white py-2 px-4 rounded cursor-pointer transition duration-300 hover:bg-yellow-600"
            >
              Subscribe
            </button>
          </div>
        ...
        <div className="hero-image md:ml-9">
          <Image
            src="/assets/images/Insights.png.png" // Verify this path
            alt="Hero Image"
            width={600}
            height={600}
